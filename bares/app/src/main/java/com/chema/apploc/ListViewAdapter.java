...
public class ListViewAdapter extends BaseAdapter {
    ...
    private List<Loc> barList = null;
    private ArrayList<Loc> arraylist;

    public ListViewAdapter(Context context,
                           List<Loc> worldpopulationlist) {
        mContext = context;
        this.barList = worldpopulationlist;
        inflater = LayoutInflater.from(mContext);
        this.arraylist = new ArrayList<Loc>();
    ...
    @Override
    public Loc getItem(int position) {
